...
│   ├── [Dataset_Name]/
│   │   └── RAW/
│   │       └── PPM/       <-- Put your original .ppm files here
```
...
#### JPL Processor (`jpl_processor.py`)
...
#### EPI Video Codec (`epi_codec_video.py`)
...
🏆 JPEG Pleno (4D-TM) is superior, producing extremely small files with high quality.
...
🏆 Video Codecs (especially AV1) dominate. On Tarot, AV1 achieved ~1000:1 compression ratio.
